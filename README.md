...
- Update the `WORDS` array in [src/constants/wordlist.ts](src/constants/orig-wordlist.ts) to only include words of the new length.
- Update the `VALID_GUESSES` array in [src/constants/validGuesses.ts](src/constants/orig-validGuesses.ts) arrays to only include words of the new length.
...
- Add all of the five letter words in the language to [src/constants/validGuesses.ts](src/constants/orig-validGuesses.ts), replacing the English words
- Add a list of goal words in the language to [src/constants/wordlist.ts](src/constants/orig-wordlist.ts), replacing the English words
